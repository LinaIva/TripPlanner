...
public class ActivityDAO {
    ...
    public void addActivity(int tripId, String activityDate, String type, String title, String description, double price) {
        String sql = "INSERT INTO activities (trip_id, activity_date, type, title, description, price) VALUES (?, ?, ?, ?, ?, ?)";
